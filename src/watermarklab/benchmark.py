...
def main():
    ...
    parser.add_argument("--methods", default="all", help="Comma-separated: all,kumar2021,roy2018,iwt_hess_svd_2024,dwt_hd_svd_2025,proposal")
    ...
    parser.add_argument("--attack-preset", default="lite", choices=["lite", "full", "stress"], help="lite is quick; full includes many attacks; stress is compact but harsher.")
